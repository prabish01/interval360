      ...
      >
        <div className="content-wrap page-gutter">
          ...
          <div className="mb-12 flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <p className="text-xs font-bold uppercase tracking-[0.2em] md:pt-2" style={{ color: homeTheme.blue }}>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="group relative overflow-hidden flex flex-col p-8 md:p-12 border border-white/5 bg-[#121318] lg:w-[60%] shrink-0 hover:border-white/10 transition-colors cursor-pointer rounded-[4px]">
                ...
                <div className="mb-12 flex items-center gap-4 z-10">
                  <span className="rounded px-2.5 py-1 text-xs font-bold uppercase tracking-wider" style={{ background: homeTheme.blue, color: "white" }}>
                    {fieldNotesSection.cards[0].tag}
                  </span>
                  <span className="text-xs font-bold uppercase tracking-wider text-white/50">{fieldNotesSection.cards[0].readTime}</span>
                </div>
                ...
                <p className="mb-16 max-w-[48ch] text-base leading-[1.6] text-white/60 z-10 font-[400]">
                  {fieldNotesSection.cards[0].body}
                </p>
                
                <div className="mt-auto flex items-center justify-between z-10 border-b border-white/10 pb-4">
                  <span className="text-xs font-bold uppercase tracking-widest text-[#f5f6f8]">
              ...
              <div className="group relative flex flex-col p-8 md:p-10 border border-white/5 bg-[#17171a] lg:w-[40%] shrink-0 hover:border-white/10 transition-colors cursor-pointer rounded-[4px]">
                <div className="flex justify-between items-start mb-10">
                  ...
                  <div className="text-right mt-1">
                    <p className="text-xs font-black uppercase tracking-widest text-white/40 mb-1.5">{fieldNotesSection.cards[1].tag}</p>
                    <p className="text-xs font-bold uppercase tracking-widest" style={{ color: homeTheme.blue }}>{fieldNotesSection.cards[1].readTime}</p>
                  </div>
                </div>
            ...
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="group flex flex-col p-8 md:p-10 border border-white/5 bg-[#1c1d22] lg:w-[40%] shrink-0 hover:border-white/10 transition-colors cursor-pointer rounded-[4px]">
                <p className="text-xs font-bold uppercase tracking-widest text-[#567bf5] mb-8">
                ...
                <div className="pl-5 border-l-2 border-white/10 mb-10 mt-4 py-1">
                  <p className="text-base leading-[1.6] text-white/50 font-serif italic pr-4">
                ...
                <div className="flex justify-between items-stretch h-full">
                  <div className="max-w-[32ch] z-10 flex flex-col h-full">
                    <div className="flex items-center gap-3 mb-8">
                      ...
                      <p className="text-xs font-bold uppercase tracking-widest" style={{ color: homeTheme.blue }}>
                    ...
                    <p className="text-base leading-[1.65] text-white/50 mb-8 pr-4">
                      {fieldNotesSection.cards[3].body}
                    </p>
                    
                    <div className="mt-auto pt-8">
                      <span className="text-xs font-bold uppercase tracking-widest text-[#f5f6f8]/40 group-hover:text-[#f5f6f8]/70 transition-colors">
            ...
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="group flex flex-col p-8 md:p-10 border border-white/5 bg-[#0b0c0f] lg:w-[40%] shrink-0 hover:border-white/10 transition-colors cursor-pointer rounded-[4px]">
                <div className="flex items-center gap-4 mb-8">
                  <span className="text-xs font-bold uppercase tracking-widest" style={{ color: homeTheme.blue }}>
                    {fieldNotesSection.cards[4].tag}
                  </span>
                  <span className="text-xs font-bold uppercase tracking-widest text-white/30">{fieldNotesSection.cards[4].readTime}</span>
                </div>
                ...
                <h3 className="mb-6 max-w-[19ch] text-[1.8rem] font-bold leading-[1.1] tracking-tight text-white mt-1" style={{ fontFamily: "var(--font-space-grotesk)" }}>
                 ...
                 <p className="text-base leading-[1.65] text-white/50 mb-12">
              ...
              <div className="group flex flex-col p-8 md:p-12 border border-white/5 bg-[#121215] lg:w-[60%] shrink-0 hover:border-white/10 transition-colors cursor-pointer rounded-[4px]">
                <div className="flex justify-between items-center mb-10">
                  <p className="text-xs font-bold uppercase tracking-widest text-[#567bf5]">
                    {fieldNotesSection.cards[5].tag}
                  </p>
                  <div className="px-3 py-1.5 bg-black/40 rounded-sm text-xs font-bold uppercase tracking-widest text-white/70">
                ...
                <p className="text-base leading-[1.65] text-white/50 max-w-[48ch] mb-16">
                ...
                <div className="mt-auto flex items-center gap-6 z-10 pt-6">
                  ...
                  <span className="text-xs font-bold uppercase tracking-[0.14em] text-white whitespace-nowrap flex items-center gap-3">
