...
const useCases = [
  {
    num: "Use Case 01",
    title: "Talent Decisions and Succession",
    body: "Get the leadership signal you need to make smarter promotion, succession, and placement decisions — based on real feedback, not anecdotes or politics.",
    who: ["CHRO / VP Talent", "CEO / COO", "HR Ops"],
  ...
  },
  {
    ...
    body: "Build a repeatable feedback cadence into your leadership development work — without the overhead, cost, or participant fatigue of traditional 360 programs.",
    who: ["L&D Leaders", "HR / Talent", "Coaches"],
      ...
      <section style={{ background: "var(--light-bg)" }}>
        ...
        <div className="mb-12">
          ...
          <h2 className="text-[clamp(1.7rem,3vw,2.3rem)] font-bold leading-[1.2] tracking-[-0.02em]" style={{ fontFamily: "var(--font-poppins)", color: "var(--navy-dark)" }}>
            Where Interval 360 makes the biggest difference.
          </h2>
        </div>
          ...
          {useCases.map((uc) => (
            ...
            >
              ...
              <div className="p-8 flex flex-col flex-1">
                <p className="text-[0.7rem] font-bold tracking-[0.15em] uppercase mb-3" style={{ color: "var(--slate)" }}>
                  {uc.num}
                </p>
                <h3 className="text-[1.15rem] font-bold mb-3" style={{ fontFamily: "var(--font-poppins)", color: "var(--navy-dark)" }}>
                  {uc.title}
                </h3>
                <p className="text-[0.92rem] leading-[1.7] mb-6 flex-1" style={{ color: "var(--slate)" }}>
                  {uc.body}
                </p>
                <div className="mb-6">
                  <p className="text-[0.72rem] font-semibold uppercase tracking-[0.1em] mb-2" style={{ color: "var(--slate)" }}>
                    Who uses this
                  </p>
                  <div className="flex flex-wrap gap-2">
                    {uc.who.map((tag) => (
                      <span
                        key={tag}
                        className="text-[0.72rem] font-semibold px-2.5 py-1 rounded"
                        style={{ background: "var(--light-bg)", color: "var(--slate)" }}
                      >
                        {tag}
                      </span>
                    ))}
                ...
                <Link href={uc.href} className="text-[0.88rem] font-semibold no-underline" style={{ color: uc.accent }}>
                  See how it works →
                </Link>
              </div>
            </div>
        ...
        <div className="flex items-center gap-4 my-16">
          ...
          <span className="text-[0.75rem] font-semibold tracking-[0.15em] uppercase px-4" style={{ color: "var(--slate)", whiteSpace: "nowrap" }}>
        ...
        >
          ...
          <div className="p-10 lg:p-14 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-[0.7rem] font-bold tracking-[0.15em] uppercase mb-3" style={{ color: "var(--teal)" }}>
                For Coaches
              </p>
              <h3 className="text-[1.5rem] font-bold leading-[1.25] mb-4" style={{ fontFamily: "var(--font-poppins)", color: "var(--navy-dark)" }}>
                A repeatable, client-ready 360 process — without building one yourself.
              </h3>
              ...
              <Link
                href="/for-coaches"
                className="inline-block text-[0.9rem] font-semibold px-7 py-3 rounded no-underline transition-colors"
