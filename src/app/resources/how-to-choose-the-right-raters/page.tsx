        ...
        <div className="content-wrap page-gutter">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(3rem, 6vw, 6rem)", alignItems: "start" }}>
            <div style={{ borderLeft: "2px solid rgba(99,102,241,0.4)", paddingLeft: "1.5rem", display: "flex", flexDirection: "column", gap: "1.1rem" }}>
              <p style={{ fontSize: "0.97rem", color: "rgba(255,255,255,0.5)", lineHeight: 1.85 }}>
            ...
            <div style={{ border: "1px solid rgba(99,102,241,0.25)", borderRadius: "8px", overflow: "hidden" }}>
              <div style={{ padding: "1.25rem 1.75rem", background: "rgba(99,102,241,0.1)", borderBottom: "1px solid rgba(99,102,241,0.2)" }}>
                <p style={{ fontSize: "0.62rem", fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: homeTheme.blue }}>Minimum requirements for report generation</p>
              </div>
              {[
                ...
                <div key={item.label} style={{ display: "flex", alignItems: "center", gap: "1.25rem", padding: "1.1rem 1.75rem", borderBottom: i < arr.length - 1 ? "1px solid rgba(255,255,255,0.06)" : "none", background: "#080808" }}>
                  <span style={{ fontFamily: "var(--font-space-grotesk), sans-serif", fontSize: "2rem", fontWeight: 800, color: homeTheme.blue, lineHeight: 1, minWidth: "2rem", textAlign: "center" }}>{item.num}</span>
                  <span style={{ fontSize: "0.88rem", color: "rgba(255,255,255,0.65)", lineHeight: 1.5 }}>{item.label}</span>
                </div>
              ))}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "120px 1fr", gap: "clamp(2rem, 4vw, 4rem)" }}>
            ...
            <div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(2rem, 4vw, 4rem)", marginBottom: "2.5rem" }}>
                <p style={{ fontSize: "0.97rem", color: "rgba(0,0,0,0.55)", lineHeight: 1.85 }}>
                ...
                <p style={{ fontSize: "0.97rem", color: "rgba(0,0,0,0.55)", lineHeight: 1.85, gridColumn: "1 / -1" }}>
              ...
              <div style={{ border: "1px solid rgba(180,120,0,0.2)", borderLeft: "3px solid rgba(180,120,0,0.5)", borderRadius: "4px", padding: "1.5rem 2rem", background: "rgba(255,180,0,0.06)" }}>
                <p style={{ fontSize: "0.62rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(140,90,0,0.9)", marginBottom: "0.65rem" }}>One thing to avoid</p>
                <p style={{ fontSize: "0.93rem", color: "rgba(0,0,0,0.55)", lineHeight: 1.8 }}>
        ...
        <div className="content-wrap page-gutter">
          <div style={{ display: "grid", gridTemplateColumns: "120px 1fr", gap: "clamp(2rem, 4vw, 4rem)" }}>
            ...
            <div>
              ...
              <h3 style={{ fontFamily: "var(--font-space-grotesk), sans-serif", fontSize: "1.15rem", fontWeight: 700, color: "#fff", marginBottom: "1.25rem" }}>What makes a strong peer rater</h3>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.25rem", marginBottom: "3rem" }}>
                <div style={{ border: "1px solid rgba(99,102,241,0.25)", borderRadius: "6px", padding: "1.75rem", background: "rgba(99,102,241,0.05)" }}>
                  <p style={{ fontSize: "0.62rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: homeTheme.blue, marginBottom: "1rem" }}>Look for</p>
                  <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "0.7rem" }}>
                    {[
                      ...
                      <li key={item} style={{ display: "flex", alignItems: "flex-start", gap: "0.6rem", fontSize: "0.86rem", color: "rgba(255,255,255,0.6)", lineHeight: 1.55 }}>
                ...
                <div style={{ border: "1px solid rgba(255,255,255,0.08)", borderRadius: "6px", padding: "1.75rem", background: "rgba(255,255,255,0.02)" }}>
                  <p style={{ fontSize: "0.62rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(255,150,100,0.8)", marginBottom: "1rem" }}>Be cautious of</p>
                  <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "0.7rem" }}>
                    {[
                      ...
                      <li key={item} style={{ display: "flex", alignItems: "flex-start", gap: "0.6rem", fontSize: "0.86rem", color: "rgba(255,255,255,0.5)", lineHeight: 1.55 }}>
              ...
              <h3 style={{ fontFamily: "var(--font-space-grotesk), sans-serif", fontSize: "1.15rem", fontWeight: 700, color: "#fff", marginBottom: "1.25rem" }}>How many to nominate</h3>
        ...
        <div className="content-wrap page-gutter">
          <div style={{ display: "grid", gridTemplateColumns: "120px 1fr", gap: "clamp(2rem, 4vw, 4rem)" }}>
            ...
            <div>
              ...
              <h3 style={{ fontFamily: "var(--font-space-grotesk), sans-serif", fontSize: "1.15rem", fontWeight: 700, color: "#0a0a0a", marginBottom: "1.25rem" }}>What makes a strong direct report rater</h3>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.25rem", marginBottom: "3rem" }}>
                <div style={{ border: "1px solid rgba(99,102,241,0.25)", borderRadius: "6px", padding: "1.75rem", background: "rgba(99,102,241,0.05)" }}>
                  <p style={{ fontSize: "0.62rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: homeTheme.blue, marginBottom: "1rem" }}>Look for</p>
                  <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "0.7rem" }}>
                    {[
                      ...
                      <li key={item} style={{ display: "flex", alignItems: "flex-start", gap: "0.6rem", fontSize: "0.86rem", color: "rgba(0,0,0,0.6)", lineHeight: 1.55 }}>
                        <span style={{ width: 6, height: 6, borderRadius: "50%", background: homeTheme.blue, flexShrink: 0, marginTop: "0.42rem" }} />
                        {item}
                      </li>
                    ))}
                ...
                <div style={{ border: "1px solid rgba(0,0,0,0.1)", borderRadius: "6px", padding: "1.75rem", background: "rgba(0,0,0,0.02)" }}>
                  <p style={{ fontSize: "0.62rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(180,60,20,0.85)", marginBottom: "1rem" }}>Be cautious of</p>
                  <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "0.7rem" }}>
                    {[
                      ...
                      <li key={item} style={{ display: "flex", alignItems: "flex-start", gap: "0.6rem", fontSize: "0.86rem", color: "rgba(0,0,0,0.5)", lineHeight: 1.55 }}>
              ...
              <h3 style={{ fontFamily: "var(--font-space-grotesk), sans-serif", fontSize: "1.15rem", fontWeight: 700, color: "#0a0a0a", marginBottom: "1.25rem" }}>On confidentiality</h3>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(2rem, 4vw, 4rem)" }}>
                <p style={{ fontSize: "0.97rem", color: "rgba(0,0,0,0.55)", lineHeight: 1.85 }}>
        ...
        <div className="content-wrap page-gutter">
          <div style={{ display: "grid", gridTemplateColumns: "120px 1fr", gap: "clamp(2rem, 4vw, 4rem)" }}>
            ...
            <div>
              ...
              <h3 style={{ fontFamily: "var(--font-space-grotesk), sans-serif", fontSize: "1.15rem", fontWeight: 700, color: "#fff", marginBottom: "1.25rem" }}>When to remove a nominee</h3>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(2rem, 4vw, 4rem)", marginBottom: "3rem" }}>
                <p style={{ fontSize: "0.97rem", color: "rgba(255,255,255,0.5)", lineHeight: 1.85 }}>
              ...
              <h3 style={{ fontFamily: "var(--font-space-grotesk), sans-serif", fontSize: "1.15rem", fontWeight: 700, color: "#fff", marginBottom: "1.25rem" }}>When to add a rater</h3>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(2rem, 4vw, 4rem)", marginBottom: "3rem" }}>
                <p style={{ fontSize: "0.97rem", color: "rgba(255,255,255,0.5)", lineHeight: 1.85 }}>
              ...
              <h3 style={{ fontFamily: "var(--font-space-grotesk), sans-serif", fontSize: "1.15rem", fontWeight: 700, color: "#fff", marginBottom: "1.25rem" }}>Reading the list as a whole</h3>
              ...
              <div style={{ border: "1px solid rgba(255,255,255,0.08)", borderLeft: `3px solid ${homeTheme.blue}`, borderRadius: "4px", padding: "1.75rem 2rem", background: "rgba(255,255,255,0.02)" }}>
                <p style={{ fontSize: "0.62rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: homeTheme.blue, marginBottom: "0.65rem" }}>A useful frame</p>
                <p style={{ fontSize: "0.93rem", color: "rgba(255,255,255,0.5)", lineHeight: 1.8 }}>
        ...
        <div className="content-wrap page-gutter">
          <div style={{ display: "grid", gridTemplateColumns: "120px 1fr", gap: "clamp(2rem, 4vw, 4rem)" }}>
            ...
            <div>
              ...
              <p style={{ fontSize: "0.97rem", color: "rgba(0,0,0,0.45)", lineHeight: 1.7, marginBottom: "2.5rem" }}>Most rater list problems follow recognizable patterns. Here are the ones that come up most often.</p>
              <div style={{ display: "flex", flexDirection: "column" }}>
                {[
                  ...
                  <div key={flag.title} style={{ display: "grid", gridTemplateColumns: "28px 1fr", gap: "1.25rem", padding: "2rem 0", borderTop: "1px solid rgba(0,0,0,0.07)", borderBottom: i === arr.length - 1 ? "1px solid rgba(0,0,0,0.07)" : "none" }}>
                    ...
                    <div>
                      <h4 style={{ fontFamily: "var(--font-space-grotesk), sans-serif", fontSize: "1rem", fontWeight: 700, color: "#0a0a0a", marginBottom: "0.65rem" }}>{flag.title}</h4>
                      <p style={{ fontSize: "0.92rem", color: "rgba(0,0,0,0.5)", lineHeight: 1.8 }}>{flag.text}</p>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <section style={{ borderTop: "1px solid rgba(255,255,255,0.08)", padding: "clamp(3rem, 6vw, 5rem) 0" }}>
        <div className="content-wrap page-gutter" style={{ maxWidth: "860px" }}>
          ...
          <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
            <Link
              href="/buy"
              style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: homeTheme.blue, color: "#fff", fontSize: "0.78rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", padding: "0.75rem 1.75rem", borderRadius: "4px", textDecoration: "none" }}
            >
              Buy an Assessment
              <ArrowRight size={14} />
            </Link>
