...
export const metadata = {
  title: "Quarterly Signal: Overcoming Survey Fatigue — Interval 360",
  description:
    "How one organisation replaced a legacy annual 360 with a lighter, AI-assisted quarterly flow — without sacrificing rigor for talent reviews.",
};
...
const stats = [
  {
    ...
    sub: "From annual to quarterly — same rigour, less drag.",
  },
  {
    value: "78%",
...
const situation = {
  eyebrow: "Situation",
  heading: "A well-run organisation with a feedback process that had stopped working",
  body: [
    "The organisation is a regional healthcare services group operating across multiple sites in the southeastern United States. At the time of engagement they employed approximately 900 people, with a leadership population of 42 managers and directors spanning clinical, operational, and administrative functions.",
    ...
    "The process was well-established. Competency frameworks were mature. Survey design was professionally structured. From the outside, it was a 360 programme that was working. From the inside, it had quietly stopped functioning as a development tool and was operating almost entirely as an administrative ritual.",
...
const challenge = {
  ...
  body: [
    "The legacy platform was not broken in any obvious way. Surveys launched on schedule. Reports generated cleanly. The competency framework was professionally built and covered the dimensions the organisation cared about. None of that was the problem.",
  ...
  raterExperience: {
    ...
    body: [
      ...
      "The result was a 58% average rater completion rate across the five years the organisation had used the platform. More than four in ten invited raters never submitted. The organisation had learned to treat this as normal.",
...
const approach = {
  ...
  pilotBody: [
    "The organisation ran a pilot with eight managers in the first cycle before expanding to the full leadership population. Pilot completion rate was 93%. HR time for the pilot cycle was under six hours. Reports were ready the same day the project closed.",
  ...
  cadenceBody: [
    "The full rollout structured four cycles across the calendar year. The Q1 cycle ran in February and was timed to feed the organisation's spring talent review. The Q2 cycle ran in May as a development check-in. The Q3 cycle ran in August at mid-year. The Q4 cycle ran in November and fed the year-end talent conversations.",
...
const cadence = [
  {
    ...
    body: "Full cycle. Covers both what and how. Data feeds directly into the organisation's spring talent review conversations.",
  },
  {
    quarter: "Q2 — May",
    title: "Development Check-in",
    body: "How dimension only. Lighter for raters. Focused on leadership behaviour and team experience in the 90 days since Q1.",
  },
  {
    quarter: "Q3 — August",
...
const outcomes = {
  ...
  dataSection: {
    ...
    body: [
      "In the first full year of quarterly cycling, the organisation completed four cycles across all 42 leaders. The Q4 cycle closed in late November — the same week the senior leadership team began talent review conversations. For the first time, the data being discussed in those conversations was current.",
  ...
  raterSection: {
    ...
    body: [
      ...
      "The qualitative character of the feedback also shifted. Reports from the legacy platform had tended toward competency ratings with brief open-text commentary. Reports from the quarterly cycles contained more specific behavioural description — raters describing particular interactions, particular decisions, particular moments of impact. The HR Director noted that this shift made the reports more useful in debrief conversations because there was actual material to discuss.",
    ],
  },
  hrSection: {
    heading: "HR capacity and cost",
    body: [
      "Total HR time across all four cycles in year one was approximately 140 hours — less than the time required to run a single annual cycle under the legacy process. Per-assessment pricing eliminated the fixed license cost and made the programme's cost directly proportional to the number of assessments completed. For a three-person HR team, the capacity that had been consumed by the annual 360 administration became available for other work.",
    ],
  },
  quote: {
  ...
  managersSection: {
    ...
    body: [
      ...
      "Several managers reported using their Q2 reports to inform specific behavioural changes before the Q3 cycle launched — a 90-day feedback loop that the annual process could not produce. The HR Director noted that this was the change she had most hoped for and least expected to see in the first year.",
    ],
  },
};
...
const intelligence = {
  ...
  sub: "From process improvement to organisational intelligence.",
  body: [
    "After four quarterly cycles, the organisation has something it has never had before: a longitudinal view of its leadership population. Each of the 42 leaders now has four data points. Patterns that are invisible in annual snapshots — who is improving, who is plateauing, who responds to feedback and who does not — are visible in the longitudinal record.",
  ...
  cards: [
    ...
    },
    {
      ...
      body: "Conversational AI captured nuance that Likert scales collapsed. Raters described specific behaviours — not abstract ratings — giving coaches actual material to work with.",
    },
  ],
};
