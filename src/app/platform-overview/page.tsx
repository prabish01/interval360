...
const differentiators = [
  {
    num: "01 — Collection",
    title: "Conversational assessment, not static surveys",
    body: "Instead of long, repetitive rating scales, feedback providers work through a five-minute guided conversation, a process that produces more specific, contextual input than traditional surveys can deliver.",
  },
  {
    num: "02 — Intelligence",
    title: "AI follow-up that improves signal quality",
    body: "When responses are vague or surface-level, the platform probes for examples and context. This is how it captures the kind of specific, nuanced feedback that traditional surveys routinely miss.",
  },
  {
    num: "03 — Outputs",
    title: "Two reports, two distinct purposes",
    body: "Every assessment produces an Assessment Report for managers and HR — built for talent decisions — and a Development Report for the leader, with structured deep dives on each strength and development area, including curated resources.",
  },
  {
    num: "04 — Scale",
    title: "Practical across more leaders, not just a few",
    body: "Because the process is faster and less costly to run, organizations can use meaningful 360 feedback across broader leadership populations — and run it on a repeatable cadence.",
  },
];
...
const modelDimensions = [
  {
    label: "The What",
    color: "var(--navy)",
    title: "Performance Against Expectations",
    items: ["Delivery on goals and commitments", "Decision quality under pressure", "Ownership and accountability", "Execution rigor and follow-through"],
  },
  {
    label: "The How",
    color: "var(--teal)",
    title: "Leadership Experience",
    items: ["How they communicate and create clarity", "How they develop and support their team", "How they build trust and psychological safety", "How they influence without authority"],
  },
];
...
const whoItems = [
  {
    ...
    title: "Buy independently, no employer needed",
    body: "A single leader can purchase an assessment directly, invite their own raters, and receive a complete report — without involving HR or waiting for a company-wide program.",
  },
  {
    label: "HR and Talent Teams",
    title: "Run across cohorts and full populations",
    body: "Enterprise accounts include centralized administration, cohort dashboards, and bulk management tools — designed for teams running assessments across 20 to 200+ leaders.",
  },
  {
    label: "Coaches and Consultants",
    title: "A structured 360 for any client, any time",
    body: "Coaches get a professional, repeatable 360 process without needing to build or license an instrument. Reports are formatted for direct use in a debrief conversation.",
  },
];
    ...
    <>
      ...
      <section className="py-24 page-gutter" style={{ background: "#fff" }}>
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            <span
              className="inline-block text-[0.72rem] font-bold tracking-[0.15em] uppercase px-3 py-1 rounded mb-5"
              style={{ background: "rgba(5,79,154,0.08)", color: "var(--navy)" }}
            >
      ...
      <section className="py-24 page-gutter" style={{ background: "#fff" }}>
        ...
        <h2 className="text-[clamp(1.7rem,3vw,2.3rem)] font-bold leading-[1.2] tracking-[-0.02em] mb-5 max-w-[28ch]" style={{ fontFamily: "var(--font-poppins)", color: "var(--navy-dark)" }}>
          Two dimensions. One complete picture.
        </h2>
        <p className="text-[1.05rem] leading-[1.75] mb-12 max-w-[60ch]" style={{ color: "var(--slate)" }}>
          Interval 360 evaluates leadership across two dimensions — what a leader delivers and how they lead. Both are required for a complete view of leadership effectiveness.
        </p>
        <div className="grid lg:grid-cols-2 gap-6">
          {modelDimensions.map((dim) => (
            <div
              ...
              style={{ background: "var(--light-bg)", borderTop: `3px solid ${dim.color}` }}
            >
              <p className="text-[0.72rem] font-bold tracking-[0.15em] uppercase mb-3" style={{ color: dim.color }}>
                {dim.label}
              </p>
              <h3 className="text-[1.15rem] font-semibold mb-5" style={{ fontFamily: "var(--font-poppins)", color: "var(--navy-dark)" }}>
                {dim.title}
              </h3>
      ...
      <section className="py-24 page-gutter" style={{ background: "var(--navy-dark)" }}>
        ...
        <h2 className="text-[clamp(1.7rem,3vw,2.3rem)] font-bold leading-[1.2] tracking-[-0.02em] mb-14 max-w-[28ch]" style={{ fontFamily: "var(--font-poppins)", color: "#fff" }}>
          Built for individuals and organizations, alike.
        </h2>
        <div className="grid lg:grid-cols-3 gap-6">
          {whoItems.map((item, i) => (
            <div
              key={i}
              className="p-8 rounded-lg"
              style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(187,220,251,0.15)" }}
            >
              <p className="text-[0.72rem] font-bold tracking-[0.15em] uppercase mb-3" style={{ color: "var(--teal)" }}>
                {item.label}
              </p>
              <h3 className="text-[1.05rem] font-semibold mb-3" style={{ fontFamily: "var(--font-poppins)", color: "#fff" }}>
                {item.title}
              </h3>
      ...
      <section className="py-28 page-gutter text-center relative overflow-hidden" style={{ background: "linear-gradient(135deg, var(--navy-dark) 0%, var(--navy) 100%)" }}>
        ...
        <div className="relative z-10">
          ...
          <p className="text-[1.05rem] leading-[1.75] mb-10 mx-auto max-w-[48ch]" style={{ color: "rgba(234,239,243,0.7)" }}>
            Buy a single assessment, or book a call to discuss an enterprise rollout.
          </p>
