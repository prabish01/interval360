    ...
    <div
      ...
      >
        ...
        <div className="relative z-10 text-center page-gutter py-24 max-w-2xl mx-auto">
          <span
            className="inline-block text-xs font-bold tracking-[0.15em] uppercase px-3 py-1.5 rounded mb-8"
          ...
          <p className="text-base leading-[1.75] mb-10" style={{ color: "rgba(234,239,243,0.75)" }}>
          ...
          <div className="flex gap-4 justify-center flex-wrap mb-16">
            <Link
              ...
              className="text-sm font-semibold px-8 py-3.5 rounded no-underline"
            ...
            <Link
              href="/pricing"
              className="text-sm font-medium no-underline border-b border-current pb-0.5"
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              >
                <p className="text-xl font-bold mb-1" style={{ fontFamily: "var(--font-montserrat)", color: "var(--teal-light)" }}>
                  {stat.val}
                </p>
                <p className="text-xs" style={{ color: "rgba(234,239,243,0.5)" }}>
                  {stat.label}
                </p>
              </div>
            ))}
